...
class SerializationCache(Cache):
    FILENAME_FORMAT = "caches/serialization_cache_stage{self.stage}.{self.FILE_EXTENSION}"
    ...
    def __init__(self, stage: int):
        ...
        self.filename = self.FILENAME_FORMAT.format(self=self)
        self.dict = {}
